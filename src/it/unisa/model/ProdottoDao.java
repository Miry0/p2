...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
	    ...
	    // Se è specificato un ordine, aggiungi un parametro al prepared statement per gestire l'input in modo sicuro
	    ...
	    try {
	        ...
	        // Se è specificato un ordine, imposta il parametro del prepared statement
	        if (order != null && !order.equals("")) {
